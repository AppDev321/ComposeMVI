...
object NetworkConstants {
    ...
    const val HEADER_KEY_CONTENT_TYPE_VALUE = "application/json"
    ...
    const val HEADER_KEY_APP_VERSION = "app_version"
    const val HEADER_SOCKET_KEY_APP_VERSION = "app-version"
